...
class QDictEdit(QTreeView):
    ...
    def update_basic_configs(self, dataset_name, dataset_size, image_count):
        self.config["Base Config"]["Dataset Name"] = dataset_name
        self.config["Base Config"]["Dataset Size"] = dataset_size
        self.config["Base Config"]["Image Count"] = image_count
        self.set_config()